...
#define OV2640_SIZE SIZE_640x480
...
public:
    ...
    virtual bool Initialise() {
        ...
        const char OV2640_InitRegTable[][3] = {
        ...
        #if ( OV2640_SIZE == SIZE_640x480 )
            /* PLL   0x10 : 30fps */
            {0x30, 0x11, 0x10}, {0x38, 0x15, 0x04},
        #elif ( OV2640_SIZE == SIZE_1280x720 || OV2640_SIZE == SIZE_1280x960 || OV2640_SIZE == SIZE_800x600 )
            /* PLL   0x08 : 15fps */
        ...
        #elif ( OV2640_SIZE == SIZE_1280x960 || OV2640_SIZE == SIZE_800x600 || OV2640_SIZE == SIZE_640x480 )
        ...
        for (uint32_t i = 0; i < (sizeof(OV2640_InitRegTable) / 3) ; i++) {
            ret = mI2c_.write(0x78, OV2640_InitRegTable[i], 3);
            if (ret != 0) {
                return false;
            }
        }
