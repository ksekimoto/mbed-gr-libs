...
static const char RaspberryPi_InitRegTable_1[][3] = {
    {0x01, 0x00, 0x00}, {0x01, 0x03, 0x01}
};
#define SIZE_RaspberryPi_InitRegTable_1 (sizeof(RaspberryPi_InitRegTable_1)/sizeof(uint8_t))

static const char RaspberryPi_InitRegTable_2[][3] = {
...
#define SIZE_RaspberryPi_InitRegTable_2 (sizeof(RaspberryPi_InitRegTable_2)/sizeof(uint8_t))
...
public:
    ...
    virtual bool Initialise() {
        ...
        ret = RASPI_reg_write_n((const uint8_t *)RaspberryPi_InitRegTable_1, SIZE_RaspberryPi_InitRegTable_1);
        if (ret != 0) {
            return false;
        }
        ...
        ret = RASPI_reg_write_n((const uint8_t *)RaspberryPi_InitRegTable_2, SIZE_RaspberryPi_InitRegTable_2);
        if (ret != 0) {
            return false;
        }
